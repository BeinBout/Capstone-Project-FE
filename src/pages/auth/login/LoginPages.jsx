...
export default function LoginPage() {
    ...
    return (
        ...
        {/* Card */}
        <div
            className="relative w-[560px] rounded-3xl overflow-hidden shadow-2xl"
        ...
        >
            ...
            <div className="flex gap-3 mb-3">
                ...
                {/* Password */}
                <div className="w-0 flex-1 flex items-center rounded-full px-5 py-3" style={{ backgroundColor: "rgba(255,255,255,0.75)", border: "1.5px solid #1a1a1a" }}>
                <input
